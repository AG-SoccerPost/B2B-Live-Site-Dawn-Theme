...
//       }
  ...
  FilterTree.prototype.afterBindEvents = function() {
    var isiOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !!navigator.platform.match(/iPhone|iPod|iPad/);
  
    if (isiOS) {
      var filterOptionsContentInner = jQ('.boost-pfs-filter-option-content-inner');
      filterOptionsContentInner.each(function(i, elm) {
        elm.style.maxHeight = '-webkit-fill-available';
      })
    }
  }
  // end Booost 156770
